 ...
 * </pre>
 */
@SuppressLint({"PrivateApi", "RestrictedApi", "NewApi"})
public class AdaptiveIconDrawableCompat extends Drawable implements Drawable.Callback {
    ...
    /**
     * Indices used to access LayerState.ChildDrawable array for foreground and
     * background layer.
     */
    ...
    private Method mExtractThemeAttrs;
     ...
     */
    protected AdaptiveIconDrawableCompat(@Nullable LayerState state, @Nullable Resources res) {
        try {
            mExtractThemeAttrs = TypedArray.class.getDeclaredMethod("extractThemeAttrs");
        ...
        mMask = PathParser.createPathFromPathData(mask);
    ...
    private void inflateLayers(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (layer.mDrawable == null && (layer.mThemeAttrs == null)) {
                ...
                layer.mDrawable = Drawable.createFromXmlInner(r,
                        new XmlPullParserShim(parser), attrs, theme);
                layer.mDrawable.setCallback(this);
    ...
    private void updateLayerFromTypedArray(@NonNull ChildDrawable layer, @NonNull TypedArray a) {
        ...
        layer.mThemeAttrs = invoke(mExtractThemeAttrs, a);

        Drawable dr = null;
        final TypedValue value = new TypedValue();
        a.getValue(0, value);
        if (value.resourceId != 0) {
            dr = a.getResources().getDrawable(value.resourceId, null);
        }
    ...
    protected static class LayerState extends ConstantState {
        ...
        public Drawable newDrawable(@Nullable Resources res) {
            try {
                return AdaptiveIconDrawable.class.getConstructor(new Class<?>[] { LayerState.class, Resources.class })
                        .newInstance(this, res);
